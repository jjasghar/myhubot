...
#   hubot <text> All don't <things> - Generates ALL THE THINGS (sad)
...
#   hubot <text> First day <text> - First day on the internet kid
#   hubot Dwight False <text> - Dwight False
#   hubot <text> Bad luck <text> - Bad luck Brian
#
# Author:
#   bobanj
#   jjasghar
...
module.exports = (robot) ->
  ...
  robot.respond /Dwight False (.+)/i, (msg) ->
    memeGenerator msg, 'http://v1.memecaptain.com/dwight_schrute.jpg', 'False', msg.match[1], (url) ->
      msg.send url

  robot.respond /(.+) Bad Luck (.+)/i, (msg) ->
    memeGenerator msg, 'http://v1.memecaptain.com/bad_luck_brian.jpg', msg.match[1], msg.match[2], (url) ->
      msg.send url
  ...
  robot.respond /(.*) (First day .*)/i, (msg) ->
    memeGenerator msg, 'http://v1.memecaptain.com/first_day_on_the_internet_kid.jpg', msg.match[1], msg.match[2], (url) ->
      msg.send url
  ...
  robot.respond /(.*) (All don't .*)/i, (msg) ->
    memeGenerator msg, 'http://v1.memecaptain.com/all_the_things2.jpg', msg.match[1], msg.match[2], (url) ->
      msg.send url
